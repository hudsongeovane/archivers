...
*************************************************************************/
#ifndef _ARCHIVE_SPEA2_TRASH_H_
#define _ARCHIVE_SPEA2_TRASH_H_

#include "Archive.h"
#include "Random.h"

template<class T>
class SPEA2ArchiveTrash : public BaseArchive<T> {
...
public:
  ...
  SPEA2ArchiveTrash (unsigned int maxsize, unsigned int dim, Random &rng)
