...
*************************************************************************/
#ifndef _MGA_ARCHIVE_TRASH_H_
#define _MGA_ARCHIVE_TRASH_H_

#include "Archive.h"
#include <iostream>

template<class T>
class MultilevelGridArchiveTrash : public BaseArchive<T>
{
public:
  ...
  MultilevelGridArchiveTrash (unsigned int maxsize, unsigned int dim)
  ...
  dominance_t add(const T &s)
  {
    ...
    trash.push_back(ArchiveElement<T>(* this->at(index_to_delete)));
