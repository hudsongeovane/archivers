#ifndef _ARCHIVE_NSGA2_TRASH_H_
#define _ARCHIVE_NSGA2_TRASH_H_

#include "Archive.h"
#include "Random.h"

template<class T>
class NSGA2ArchiveTrash : public BaseArchive<T> {
...
public:
  ...
  NSGA2ArchiveTrash (unsigned int maxsize, unsigned int dim, Random &rng)
